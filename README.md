...
```
npm install          # run at the repo root; installs all workspace packages
...
| Database | SQLite via `better-sqlite3`; raw SQL, no ORM | An ORM would hide the SQL, and understanding the SQL is part of the project |
